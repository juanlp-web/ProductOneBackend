...
async function createAccountConfigs(tenantId, userId, allAccounts) {
  const defaultConfigs = {
    ...
    compras: {
      ...
      devoluciones: { code: '512', name: 'Gastos Administrativos', type: 'gasto' }
    },
    bancos: {
  ...
  try {
    ...
    if (!tenant) {
      tenant = new Tenant({
        ...
        subdomain: 'principal',
        companyName: 'Innovadomprod',
        companyEmail: 'admin@innovadomprod.com',
        companyPhone: '18090000000',
        companyAddress: {
